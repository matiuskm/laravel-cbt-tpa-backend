        ...
        <div class="card-body">
          <form method="POST" action="{{route('question.update', $question->id)}}">
              ...
              <div class="selectgroup w-100">
                  <label class="selectgroup-item">
                      <input type="radio"
                          ...
                          {{$question->category == 'Numeric' ? 'checked' : ''}}>
                  ...
                  <label class="selectgroup-item">
                      <input type="radio"
                          ...
                          value="Verbal"
                          class="selectgroup-input"
                          {{$question->category == 'Verbal' ? 'checked' : ''}}>
                  ...
                  <label class="selectgroup-item">
                      <input type="radio"
                          ...
                          value="Logika"
                          class="selectgroup-input"
                          {{$question->category == 'Logika' ? 'checked' : ''}}>
            ...
            <div class="form-group">
              ...
              <textarea name="question" class="summernote-simple @error('question') is-invalid @enderror">{{$question->question}}</textarea>
              @error('question')
